...
def parse_args():
    ...
    parser.add_argument("--input-csv", default="groq_tagged_cities.csv")
    parser.add_argument("--embeddings-out", default="world-subcountries-tagged-embeddings.npy")
    parser.add_argument("--metadata-out", default="world-subcountries-tagged-metadata.json")
    parser.add_argument("--index-out", default="world-subcountries-tagged.index")
